...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/v1/byosnap-core/settings',
        ...
        app.put('/v1/byosnap-core/settings',
            ...(fetchMiddlewares<RequestHandler>(SettingsController)),
        ...
        app.get('/v1/byosnap-core/settings/custom',
            ...(fetchMiddlewares<RequestHandler>(SettingsController)),
        ...
        app.put('/v1/byosnap-core/settings/custom',
            ...(fetchMiddlewares<RequestHandler>(SettingsController)),
        ...
        app.get('/v1/byosnap-core/settings/export',
            ...(fetchMiddlewares<RequestHandler>(SettingsController)),
        ...
        app.post('/v1/byosnap-core/settings/import',
            ...(fetchMiddlewares<RequestHandler>(SettingsController)),
        ...
        app.post('/v1/byosnap-core/settings/validate-import',
            ...(fetchMiddlewares<RequestHandler>(SettingsController)),
        ...
        app.get('/v1/byosnap-core/settings/users/:userId/custom',
            ...(fetchMiddlewares<RequestHandler>(SettingsController)),
        ...
        app.post('/v1/byosnap-core/settings/users/:userId/custom',
            ...(fetchMiddlewares<RequestHandler>(SettingsController)),
        ...
        app.get('/v1/byosnap-core/settings/users/:userId/data',
            ...(fetchMiddlewares<RequestHandler>(SettingsController)),
        ...
        app.put('/v1/byosnap-core/settings/users/:userId/data',
            ...(fetchMiddlewares<RequestHandler>(SettingsController)),
        ...
        app.delete('/v1/byosnap-core/settings/users/:userId/data',
            ...(fetchMiddlewares<RequestHandler>(SettingsController)),
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsExampleController_exampleUserAuth: Record<string, TsoaRoute.ParameterSchema> = {
                _unauthorized: {"in":"res","name":"401","required":true,"ref":"ErrorResponse"},
                userId: {"in":"path","name":"userId","required":true,"dataType":"string"},
                req: {"in":"request","name":"req","required":true,"dataType":"object"},
        };
        app.get('/v1/byosnap-core/users/:userId/example',
            ...(fetchMiddlewares<RequestHandler>(ExampleController)),
            ...(fetchMiddlewares<RequestHandler>(ExampleController.prototype.exampleUserAuth)),

            async function ExampleController_exampleUserAuth(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsExampleController_exampleUserAuth, request, response });

                const controller = new ExampleController();

              await templateService.apiHandler({
                methodName: 'exampleUserAuth',
                controller,
                response,
                next,
                validatedArgs,
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsExampleController_exampleApiKeyAuth: Record<string, TsoaRoute.ParameterSchema> = {
                _unauthorized: {"in":"res","name":"401","required":true,"ref":"ErrorResponse"},
                req: {"in":"request","name":"req","required":true,"dataType":"object"},
        };
        app.get('/v1/byosnap-core/example/api-key',
            ...(fetchMiddlewares<RequestHandler>(ExampleController)),
            ...(fetchMiddlewares<RequestHandler>(ExampleController.prototype.exampleApiKeyAuth)),

            async function ExampleController_exampleApiKeyAuth(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsExampleController_exampleApiKeyAuth, request, response });

                const controller = new ExampleController();

              await templateService.apiHandler({
                methodName: 'exampleApiKeyAuth',
                controller,
                response,
                next,
                validatedArgs,
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsExampleController_exampleInternalAuth: Record<string, TsoaRoute.ParameterSchema> = {
                _unauthorized: {"in":"res","name":"401","required":true,"ref":"ErrorResponse"},
                req: {"in":"request","name":"req","required":true,"dataType":"object"},
        };
        app.get('/v1/byosnap-core/example/internal',
            ...(fetchMiddlewares<RequestHandler>(ExampleController)),
            ...(fetchMiddlewares<RequestHandler>(ExampleController.prototype.exampleInternalAuth)),

            async function ExampleController_exampleInternalAuth(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsExampleController_exampleInternalAuth, request, response });

                const controller = new ExampleController();

              await templateService.apiHandler({
                methodName: 'exampleInternalAuth',
                controller,
                response,
                next,
                validatedArgs,
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsExampleController_exampleAdminSdk: Record<string, TsoaRoute.ParameterSchema> = {
                _unauthorized: {"in":"res","name":"401","required":true,"ref":"ErrorResponse"},
                req: {"in":"request","name":"req","required":true,"dataType":"object"},
        };
        app.get('/v1/byosnap-core/example/admin',
            ...
            async function ExampleController_exampleAdminSdk(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsExampleController_exampleAdminSdk, request, response });

                const controller = new ExampleController();

              await templateService.apiHandler({
                methodName: 'exampleAdminSdk',
                controller,
                response,
                next,
                validatedArgs,
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsExampleController_exampleMultiAuth: Record<string, TsoaRoute.ParameterSchema> = {
                _unauthorized: {"in":"res","name":"401","required":true,"ref":"ErrorResponse"},
                userId: {"in":"path","name":"userId","required":true,"dataType":"string"},
                req: {"in":"request","name":"req","required":true,"dataType":"object"},
        };
        app.get('/v1/byosnap-core/users/:userId/example/multi-auth',
            ...(fetchMiddlewares<RequestHandler>(ExampleController)),
            ...(fetchMiddlewares<RequestHandler>(ExampleController.prototype.exampleMultiAuth)),

            async function ExampleController_exampleMultiAuth(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsExampleController_exampleMultiAuth, request, response });

                const controller = new ExampleController();

              await templateService.apiHandler({
                methodName: 'exampleMultiAuth',
                controller,
                response,
                next,
                validatedArgs,
