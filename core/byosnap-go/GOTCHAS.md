...
1. **URL Prefix**: All externally accessible APIs need to start with `/v1/byosnap-core/`. The Snapend ID is NOT part of the URL - this allows you to use the same BYOSnap in multiple Snapends.
