...
class StorageInsertBlobRequest(BaseModel):
    """
    ...
    __properties = ["access_type", "blob_key", "owner_id", "ttl", "value"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StorageInsertBlobRequest:
        """Create an instance of StorageInsertBlobRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StorageInsertBlobRequest:
        """Create an instance of StorageInsertBlobRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StorageInsertBlobRequest.parse_obj(obj)

        _obj = StorageInsertBlobRequest.parse_obj({
