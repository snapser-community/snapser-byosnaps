...
class AuthFacebookLoginRequest(BaseModel):
    """
    ...
    token: StrictStr = Field(..., description="Facebook token generated on the client")
    __properties = ["create_user", "login_metadata", "token"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthFacebookLoginRequest:
        """Create an instance of AuthFacebookLoginRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthFacebookLoginRequest:
        """Create an instance of AuthFacebookLoginRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthFacebookLoginRequest.parse_obj(obj)

        _obj = AuthFacebookLoginRequest.parse_obj({
