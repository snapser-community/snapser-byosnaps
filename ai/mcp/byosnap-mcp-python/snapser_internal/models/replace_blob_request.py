...
class ReplaceBlobRequest(BaseModel):
    """
    ReplaceBlobRequest
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReplaceBlobRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReplaceBlobRequest:
        """Create an instance of ReplaceBlobRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReplaceBlobRequest.parse_obj(obj)

        _obj = ReplaceBlobRequest.parse_obj({
            "cas": obj.get("cas"),
