...
class AuthUser(BaseModel):
    ...
    logins: Optional[conlist(AuthLoginId)] = Field(None, description="List of login IDs associated with the user")
    ...
    __properties = ["created", "created_at", "first_login", "id", "is_banned", "is_suspended", "is_verified", "login_types", "logins", "refreshed_at", "session_token", "suspended_until", "tags", "token_validity_seconds"]
    ...
    def from_dict(cls, obj: dict) -> AuthUser:
        ...
        _obj = AuthUser.parse_obj({
            ...
            "logins": [AuthLoginId.from_dict(_item) for _item in obj.get("logins")] if obj.get("logins") is not None else None,
