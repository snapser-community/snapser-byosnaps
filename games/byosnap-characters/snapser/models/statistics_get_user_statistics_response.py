...
class StatisticsGetUserStatisticsResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StatisticsGetUserStatisticsResponse:
        """Create an instance of StatisticsGetUserStatisticsResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StatisticsGetUserStatisticsResponse:
        """Create an instance of StatisticsGetUserStatisticsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StatisticsGetUserStatisticsResponse.parse_obj(obj)

        _obj = StatisticsGetUserStatisticsResponse.parse_obj({
