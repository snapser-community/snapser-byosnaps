...
func (o *AuthRefreshRequest) GetLoginMetadata() AuthLoginMetadata {
...
func (o *AuthRefreshRequest) GetLoginMetadataOk() (*AuthLoginMetadata, bool) {
	if o == nil || IsNil(o.LoginMetadata) {
		return nil, false
	}
...
func (o *AuthRefreshRequest) HasLoginMetadata() bool {
	if o != nil && !IsNil(o.LoginMetadata) {
		return true
	}
...
func (o *AuthRefreshRequest) SetLoginMetadata(v AuthLoginMetadata) {
	o.LoginMetadata = &v
}
