...
func (o *AuthSteamOpenIdLoginRequest) GetLoginMetadata() AuthLoginMetadata {
...
// and a boolean to check if the value has been set.
func (o *AuthSteamOpenIdLoginRequest) GetLoginMetadataOk() (*AuthLoginMetadata, bool) {
	if o == nil || IsNil(o.LoginMetadata) {
		return nil, false
	}
...
func (o *AuthSteamOpenIdLoginRequest) HasLoginMetadata() bool {
	if o != nil && !IsNil(o.LoginMetadata) {
		return true
	}
...
func (o *AuthSteamOpenIdLoginRequest) SetLoginMetadata(v AuthLoginMetadata) {
	o.LoginMetadata = &v
}
