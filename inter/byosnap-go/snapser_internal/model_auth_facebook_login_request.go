...
func (o *AuthFacebookLoginRequest) GetLoginMetadata() AuthLoginMetadata {
...
// and a boolean to check if the value has been set.
func (o *AuthFacebookLoginRequest) GetLoginMetadataOk() (*AuthLoginMetadata, bool) {
	if o == nil || IsNil(o.LoginMetadata) {
		return nil, false
	}
...
func (o *AuthFacebookLoginRequest) HasLoginMetadata() bool {
	if o != nil && !IsNil(o.LoginMetadata) {
		return true
	}
...
func (o *AuthFacebookLoginRequest) SetLoginMetadata(v AuthLoginMetadata) {
	o.LoginMetadata = &v
}
