...
type AuthUser struct {
	...
	Logins []AuthLoginId `json:"logins,omitempty"`
...
func (o *AuthUser) GetLogins() []AuthLoginId {
...
// and a boolean to check if the value has been set.
func (o *AuthUser) GetLoginsOk() ([]AuthLoginId, bool) {
	if o == nil || IsNil(o.Logins) {
		return nil, false
	}
...
func (o *AuthUser) HasLogins() bool {
	if o != nil && !IsNil(o.Logins) {
		return true
	}
...
// SetLogins gets a reference to the given []AuthLoginId and assigns it to the Logins field.
func (o *AuthUser) SetLogins(v []AuthLoginId) {
	o.Logins = v
}
