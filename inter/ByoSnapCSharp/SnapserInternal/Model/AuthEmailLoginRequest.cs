...
namespace SnapserInternal.Model
{
    ...
    public partial class AuthEmailLoginRequest : IEquatable<AuthEmailLoginRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public AuthEmailLoginRequest(bool createUser = default(bool), string email = default(string), AuthLoginMetadata loginMetadata = default(AuthLoginMetadata), string otp = default(string))
        {
