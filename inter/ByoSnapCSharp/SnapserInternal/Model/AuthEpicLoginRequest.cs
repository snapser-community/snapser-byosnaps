...
namespace SnapserInternal.Model
{
    ...
    public partial class AuthEpicLoginRequest : IEquatable<AuthEpicLoginRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public AuthEpicLoginRequest(string code = default(string), bool createUser = default(bool), string exchangeCode = default(string), string grantType = default(string), AuthLoginMetadata loginMetadata = default(AuthLoginMetadata), string password = default(string), string username = default(string))
        {
