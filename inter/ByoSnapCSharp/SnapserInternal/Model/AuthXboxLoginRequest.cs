...
namespace SnapserInternal.Model
{
    ...
    public partial class AuthXboxLoginRequest : IEquatable<AuthXboxLoginRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public AuthXboxLoginRequest(string code = default(string), bool createUser = default(bool), AuthLoginMetadata loginMetadata = default(AuthLoginMetadata), string redirectUrl = default(string))
        {
