...
namespace SnapserInternal.Model
{
    ...
    public partial class AuthSteamSessionTicketLoginRequest : IEquatable<AuthSteamSessionTicketLoginRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public AuthSteamSessionTicketLoginRequest(bool createUser = default(bool), string identity = default(string), AuthLoginMetadata loginMetadata = default(AuthLoginMetadata), string sessionTicket = default(string))
        {
